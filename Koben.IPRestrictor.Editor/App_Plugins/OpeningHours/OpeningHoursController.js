(function() {
    ...
    function openingController($scope, assetsService, localizationService) {
        ...
        assetsService.loadCss("/App_Plugins/OpeningHours/libs/jquery.timepicker.css");
        ...
        function GetLocalized(day) {
            return day; 
            // return localizationService.dictionary['openinghours_' + day] || day;
        }

    }

    angular.module('umbraco')
        .controller('kobenOpeningHoursController', openingController);
